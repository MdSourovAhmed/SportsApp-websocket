...
export function attachWebSocketServer(server) {
  ...
  // FIX #3: broadcastScoreUpdate was entirely missing from this file.
  // The PATCH /:id/score route called res.app.locals.broadcastScoreUpdate()
  // but it was never created here and never returned/registered in server.js.
